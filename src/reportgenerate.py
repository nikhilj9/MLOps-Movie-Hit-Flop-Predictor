...
report = Report(metrics=[ClassificationQualityMetric(), DataDriftPreset()])
...
print(
    "Monitoring report with drift saved: monitoring_reports/classification_and_drift_report.html"
)
